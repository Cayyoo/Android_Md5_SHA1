...
public class EncryptActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_encrypt_demo);
        ...
        tv04= (TextView) this.findViewById(R.id.tv04);
        tv05= (TextView) this.findViewById(R.id.tv05);
        tv06= (TextView) this.findViewById(R.id.tv06);

        tv01.setText(getHash("小奎", "MD5"));
        tv02.setText(getHash("小奎", "SHA") + "\n");

        tv03.setText(getHash2("小奎", "MD5"));
        tv04.setText(getHash2("小奎", "SHA") + "\n");

        tv05.setText(getHash3("小奎", "MD5"));
        tv06.setText(getHash3("小奎", "SHA") + "\n");
    }
